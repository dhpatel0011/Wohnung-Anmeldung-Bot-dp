...
def main():
    # 1. Initialize files upfront to prevent Git pathspec errors
    ...
    try:
        # Use curl_cffi with Chrome TLS impersonation to bypass 403 blocks
        response = requests.get(SEARCH_URL, headers=headers, impersonate="chrome120", timeout=30)
    except Exception as e:
